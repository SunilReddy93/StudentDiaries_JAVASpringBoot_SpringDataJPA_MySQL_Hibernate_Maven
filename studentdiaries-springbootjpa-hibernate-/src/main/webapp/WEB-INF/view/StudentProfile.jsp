...
<header id="header">
    <div class="container container1" id="container-header" >
        <div class="row">
            <div class="col-md-6">
                <div class="fafaicons">
                    <a href="/student/dashboard" title="Dashboard"><i class="material-icons md-dark">arrow_back</i></a>
                </div>
            </div>


            <div class="fafaicons d-flex justify-content-end float-right ml-auto">
                <a  href="/student/profile/update/form" title="Edit Profile"><span><i class="material-icons">create</i></span></a></div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="/student/account/delete"> <button type="button" class="btn btn-primary">Yes</button></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row ">
                ...
                <div class="col-md-8 px-3">
                    <div class="card-block px-3">
                        ...
                        <p class="card-text">Reference Teacher ID: <%= student.getTeacherId() %>,</p>
                        <p class="card-text"><%= WordUtils.capitalizeFully(student.getStudentCourse()) %>,  <%= WordUtils.capitalizeFully(student.getStudentSchool()) %></p>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item"><p>Roll No:  <%= student.getRollno() %></p></li>
                            ...
                            <li class="list-group-item"><p><span><i class="fa fa-envelope"></i>  </span>  Personal Email ID:  <%= student.getStudentEmail() %></p></li>

                            <li class="list-group-item"><p><span><i class="fa fa-phone"></i></span>  Personal Phone No.:  <%= student.getStudentPhone() %></p> </li>

                            <li class="list-group-item"><p><span><i class="fa fa-envelope"></i></span>  Parent Email ID:  <%= student.getParentEmail() %></p></li>

                            <li class="list-group-item"><p><span><i class="fa fa-phone"></i></span>  Parent Phone No.:  <%= student.getParentPhone() %></p> </li>
