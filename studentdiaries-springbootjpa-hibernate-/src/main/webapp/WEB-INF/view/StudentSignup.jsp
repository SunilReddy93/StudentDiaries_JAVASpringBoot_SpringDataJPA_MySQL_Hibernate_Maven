...
<section>
    <div class="container signupform">
        <div class="row">
            ...
            <div class="col">
                <form action="/student/save" method="POST" id="myform3">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6 final">
                            <p>Already a Student Member? <a href="/student/login">Signin</a></p>
                        </div>
...
<script src="/static/javascript/AJAX/AjaxStudentTeacherID.js"></script>
