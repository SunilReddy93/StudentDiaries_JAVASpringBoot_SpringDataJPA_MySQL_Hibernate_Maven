    ...
    <div id="sidebar-container" class="sidebar-expanded d-none d-md-block"><!-- d-* hiddens the Sidebar in smaller devices. Its itens can be kept on the Navbar 'Menu' -->
        ...
        <ul class="list-group">
            ...
            <div id='submenu1' class="collapse sidebar-submenu">
                <a href="/student/datepick" class="teacherspage list-group-item list-group-item-action bg-dark text-white" >
            ...
            <div id='submenu2' class="collapse sidebar-submenu">
                <a href="/student/profile" class="list-group-item list-group-item-action bg-dark text-white">
                    <span class="menu-collapsed">Profile Settings</span>
                </a>
                <a href="/student/password/change" class="list-group-item list-group-item-action bg-dark text-white">
            ...
            <!-- /END Separator -->
            <a href="/student/calendar" class="bg-white text-dark list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
...
<script src="/static/javascript/Dashboard/studentdashboardcount.js"></script>
<script src="/static/javascript/Dashboard/studentdashboardchart.js"></script>
<script src="/static/javascript/Dashboard/StudentDashboardChart2.js"></script>
