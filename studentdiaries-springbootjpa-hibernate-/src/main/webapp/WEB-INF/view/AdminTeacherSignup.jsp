...
<section>
    <div class="container signupform">
        <div class="row">
            ...
            <div class="col">
                <form action="/admin/teacher/save" method="POST" id="myform2">
                    ...
                    <div class="form-row">
                        ...
                        <div class=" form-group col-md-6">
                            ...
                            <select class="form-control" name="adminId" id="adminid" required>
                                ...
                                <option value="<%= session.getAttribute("sessionadminid").toString() %>"><%= session.getAttribute("sessionadminid").toString() %></option>
                        ...
                        <div class="col-md-6 final">
                            <a href="/admin/teachers" class="btn btn-primary">Go back</a>
                        </div>
