...
<div class="col-md-6 offset-md-3">
    ...
    <div class="card  border-info">
        ...
        <div class="card-body">
            <form class="form" role="form" autocomplete="off" action="/admin/password/change/submit" method="post">
                ...
                <div class="form-group">
                    <a class="btn btn-primary btn-lg" href="/admin/dashboard">Go Back</a>
