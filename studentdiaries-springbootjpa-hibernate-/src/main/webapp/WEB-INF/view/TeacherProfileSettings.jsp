...
<header id="header">
    <div class="container container1" id="container-header" >
        <div class="row">
            <div class="col-md-6">
                <div class="fafaicons">
                    <a href="/teacher/dashboard" title="Dashboard"><i class="material-icons md-dark">arrow_back</i></a>
                </div>
            </div>


            <div class="fafaicons d-flex justify-content-end float-right ml-auto">
                <a  href="/teacher/profile/update/form" title="Edit Profile"><span><i class="material-icons">
create</i></span></a>
            </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="/teacher/account/delete"> <button type="button" class="btn btn-primary">Yes</button></a>
                        </div>
                    </div>
                </div>
            </div>
