...
<%@ page import="com.studentdiaries.springboot.Service.AdminService" %><%--
           ...
           The sidebar isn't proper for smaller screens imo, so this dropdown menu can keep all the useful sidebar itens exclusively for smaller screens  -->
                <li class="nav-item dropdown d-sm-block d-md-none">
                    ...
                    <div class="dropdown-menu" aria-labelledby="smallerscreenmenu">
                        ...
                        <a class="teacherspage dropdown-item" href="/admin/teachers">Teachers</a>
...
<div class="row" id="body-row">
    ...
    <div id="sidebar-container" class="sidebar-expanded d-none d-md-block"><!-- d-* hiddens the Sidebar in smaller devices. Its itens can be kept on the Navbar 'Menu' -->
        ...
        <ul class="list-group">
            ...
            <div id='submenu1' class="collapse sidebar-submenu">
                <a href="/admin/teachers" class="teacherspage list-group-item list-group-item-action bg-dark text-white">
                    <span class="menu-collapsed">Teachers</span>
                </a>
                <a href="/admin/teachers/students" class="studentspage list-group-item list-group-item-action bg-dark text-white">
            ...
            <div id='submenu2' class="collapse sidebar-submenu">
                <a href="/admin/profile" class="list-group-item list-group-item-action bg-dark text-white">
                    <span class="menu-collapsed">Profile Settings</span>
                </a>
                <a href="/admin/password/change" class="list-group-item list-group-item-action bg-dark text-white">
            ...
            <!-- /END Separator -->
            <a href="/admin/calender" class="bg-white text-dark list-group-item list-group-item-action">
                <div class="d-flex w-100 justify-content-start align-items-center">
    ...
    <%
        Integer id = (Integer) request.getAttribute("count");
    %>
    ...
    <div class="col-md-8" id="main-page">
        ...
        <div class="card text-center col-md-6 col-lg-12 countcard">
            ...
            <div class="card-body align-items-center">
                <h1 class="text-center" ><strong id="count" data-max="<%= id %>"><%= id %></strong></h1>
...
<!--LINE CHART-->
<script src="/static/javascript/Dashboard/AdminDashboardChart.js"></script>

<!--TEACHER COUNT-->
<script src="/static/javascript/Dashboard/AdminDashboardTeacherCount.js"></script>
